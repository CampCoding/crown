            ...
            <div className="col-12 col-lg-6">
              <div className="blog__single-thumb overflow-hidden rounded-3xl relative">
                <Link href="/blog-single" data-cursor="read">
                  <Image
                    src={one}
                    alt="The Ultimate Marketing Checklist 2026 - Crown Agency"
            ...
            <div className="col-12 col-lg-6">
              <div className="blog__single-content lg:pl-10">
                <div className="blog__single-meta mb-6">
                  <Link
                    href="/blog"
                    className="sub-title text-primary font-bold! tracking-widest uppercase"
                  >
                    Marketing
                    <i className="fa-solid fa-arrow-right ml-2"></i>
                  </Link>
                  <span className="text-white/40 ml-6 font-medium">
                    APRIL 27, 2026
                  </span>
                </div>
                <h2 className="mb-8">
                  <Link
                    href="/blog-single"
                    className="text-white! hover:text-primary! transition-all duration-300 title-anim"
                  >
                    The Ultimate Creative Marketing Checklist for 2026
                  </Link>
                </h2>
                <p className="text-white/60 text-lg mb-10 max-w-lg">
                  Elevate your brand with Crown&apos;s comprehensive marketing
                  checklist designed for the modern digital landscape.
                </p>
                <Link
                  href="/blog-single"
          ...
          <div className="blog__single row gaper align-items-center fade-top group flex-row-reverse">
            <div className="col-12 col-lg-6">
              <div className="blog__single-thumb overflow-hidden rounded-3xl relative">
                <Link href="/blog-single" data-cursor="read">
                  <Image
                    src={two}
                    alt="High-Impact Content Strategy - Crown Agency"
                    className="w-full h-[400px]! object-cover group-hover:scale-105 transition-transform duration-1000"
                  />
                  <div className="absolute inset-0 bg-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </Link>
            ...
            <div className="col-12 col-lg-6">
              <div className="blog__single-content lg:pr-10">
                ...
                <p className="text-white/60 text-lg mb-10 max-w-lg">
                  Learn how Crown creates content that resonates and drives
