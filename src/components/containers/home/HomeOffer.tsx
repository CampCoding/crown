...
const HomeOffer = () => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      if (deviceWidth > 576) {
        caseStudyItems.forEach((item) => {
          ...
          const thirdChild = item.querySelector(".offer-thumb-hover") as HTMLElement;
          if (thirdChild) {
            gsap.to(thirdChild, {
              x: dx,
              y: dy,
  ...
  backgroundRepeat: "no-repeat",
    ...
    className="section bg-(--black)! offer fade-wrapper overflow-hidden position-relative">
          ...
          <div className="col-12 col-lg-5">
            <div className="offer__content section__content fade-top">
              ...
              <h2 className="title title-anim text-white!">
                Empowering Your Brand with Creative Excellence
              </h2>
              <div className="paragraph">
                <p className="text-lg">
                  We provide a comprehensive suite of creative services designed
                  to elevate your business. From professional shooting and
                  modern branding to strategic content and business development,
                  we bring your vision to life.
                </p>
              </div>
              <div className="section__content-cta fade-top mt-10">
                <Link href="our-services" className="btn btn--secondary hover:bg-primary hover:text-white! transition-all duration-300">
                  view all services
                </Link>
              </div>
            </div>
      ...
      <Image src={star} alt="Image" className="star opacity-20" />
